...
const CarouselCard = class {
    ...
    render() {
        ...
        return (index.h("main", { key: '91ff0895d62311cd7358d64275ccc47f3d3b7fcc', id: "carouselCard" }, index.h("span", { key: 'fc622f9cc93e8820477a406d169758b26551a2d9', class: "reviewSiteLogo" }, index.h("img", { key: '8364e3a8aea5278d1ca9c02bf3e11dd98abf6a99', src: this.siteLogo, alt: "Review Site Logo" })), index.h("div", { key: '2031701ed85ef27c1f78a9462845bc1d6be99fef', class: "starsContainer" }, ratingStars), index.h("p", { key: 'eb8c77d0147dead9a63dc2da03ee9f5603f7aca4' }, "(", this.numberStars, " out of 5)")));
    }
};
